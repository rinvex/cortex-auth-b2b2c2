...
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AuthenticationRequest;
...
class AuthenticationController extends AbstractController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AuthenticationRequest $request
     *
    ...
    protected function sendLoginResponse(Request $request)
    {
        ...
        if ($totpStatus || $phoneStatus) {
            ...
            $route = $totpStatus
                ? route('managerarea.verification.phone.verify')
                : route('managerarea.verification.phone.request');
