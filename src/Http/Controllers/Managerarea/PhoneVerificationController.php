...
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\PhoneVerificationRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\PhoneVerificationSendRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\PhoneVerificationVerifyRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\PhoneVerificationProcessRequest;
...
class PhoneVerificationController extends AbstractController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\PhoneVerificationRequest $request
     *
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\PhoneVerificationSendRequest $request
     *
     ...
     * Show the phone verification form.
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\PhoneVerificationVerifyRequest $request
     *
     * @return \Illuminate\View\View
     */
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\PhoneVerificationProcessRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
