...
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AccountTwoFactorPhoneRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AccountTwoFactorTotpBackupRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AccountTwoFactorTotpProcessRequest;
...
class AccountTwoFactorController extends AuthenticatedController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AccountTwoFactorTotpProcessRequest $request
     * @param \PragmaRX\Google2FA\Google2FA                                                    $totpProvider
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AccountTwoFactorTotpBackupRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AccountTwoFactorPhoneRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
