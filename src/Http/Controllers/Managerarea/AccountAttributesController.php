...
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AccountAttributesRequest;
...
class AccountAttributesController extends AuthenticatedController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\AccountAttributesRequest $request
     *
