...
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\EmailVerificationRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\EmailVerificationSendRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Managerarea\EmailVerificationProcessRequest;
...
class EmailVerificationController extends AbstractController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\EmailVerificationRequest $request
     *
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\EmailVerificationSendRequest $request
     *
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Managerarea\EmailVerificationProcessRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
    public function verify(EmailVerificationProcessRequest $request)
    {
        ...
        switch ($result) {
            ...
            default:
                return intend([
                    'url' => route('managerarea.verification.email.request'),
                    'withInput' => $request->only(['email']),
                    'withErrors' => ['email' => trans('cortex/auth::'.$result)],
                ]);
        }
