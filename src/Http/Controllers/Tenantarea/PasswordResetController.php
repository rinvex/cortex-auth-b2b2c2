...
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PasswordResetRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PasswordResetSendRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PasswordResetProcessRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PasswordResetPostProcessRequest;
...
class PasswordResetController extends AbstractController
{
     ...
     *
     * @param Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PasswordResetRequest
     *
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PasswordResetProcessRequest $request
     *
     * @return \Illuminate\View\View
     */
