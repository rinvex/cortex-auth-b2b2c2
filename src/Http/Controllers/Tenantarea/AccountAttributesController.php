...
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AccountAttributesRequest;
...
class AccountAttributesController extends AuthenticatedController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AccountAttributesRequest $request
     *
