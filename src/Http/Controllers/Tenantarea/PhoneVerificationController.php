...
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PhoneVerificationRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PhoneVerificationSendRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PhoneVerificationVerifyRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PhoneVerificationProcessRequest;
...
class PhoneVerificationController extends AbstractController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PhoneVerificationRequest $request
     *
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PhoneVerificationSendRequest $request
     *
     ...
     * Show the phone verification form.
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PhoneVerificationVerifyRequest $request
     *
     * @return \Illuminate\View\View
     */
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PhoneVerificationProcessRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
