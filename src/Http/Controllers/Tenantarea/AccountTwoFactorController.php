...
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AccountTwoFactorPhoneRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AccountTwoFactorTotpBackupRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AccountTwoFactorTotpProcessRequest;
...
class AccountTwoFactorController extends AuthenticatedController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AccountTwoFactorTotpProcessRequest $request
     * @param \PragmaRX\Google2FA\Google2FA                                                   $totpProvider
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AccountTwoFactorTotpBackupRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AccountTwoFactorPhoneRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
