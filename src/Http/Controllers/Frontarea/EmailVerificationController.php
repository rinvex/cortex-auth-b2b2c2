...
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\EmailVerificationRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\EmailVerificationSendRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\EmailVerificationProcessRequest;
...
class EmailVerificationController extends AbstractController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\EmailVerificationRequest $request
     *
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\EmailVerificationSendRequest $request
     *
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\EmailVerificationProcessRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
