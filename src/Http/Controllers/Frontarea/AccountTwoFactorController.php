...
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\AccountTwoFactorPhoneRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\AccountTwoFactorTotpBackupRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\AccountTwoFactorTotpProcessRequest;
...
class AccountTwoFactorController extends AuthenticatedController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cortex/auth::frontarea.pages.account-twofactor', compact('twoFactor'));
    }
    ...
    public function enableTotp(Request $request, Google2FA $totpProvider)
    {
        ...
        return view('cortex/auth::frontarea.pages.account-twofactor-totp', compact('secret', 'qrCode', 'twoFactor'));
    }
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\AccountTwoFactorTotpProcessRequest $request
     * @param \PragmaRX\Google2FA\Google2FA                                                  $totpProvider
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\AccountTwoFactorTotpBackupRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\AccountTwoFactorPhoneRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
