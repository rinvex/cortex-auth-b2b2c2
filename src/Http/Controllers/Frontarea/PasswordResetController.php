...
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PasswordResetRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PasswordResetSendRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PasswordResetProcessRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PasswordResetPostProcessRequest;
...
class PasswordResetController extends AbstractController
{
     ...
     *
     * @param Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PasswordResetRequest
     *
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PasswordResetSendRequest $request
     *
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PasswordResetProcessRequest $request
     *
     * @return \Illuminate\View\View
     */
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PasswordResetPostProcessRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
