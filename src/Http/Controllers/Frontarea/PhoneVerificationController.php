...
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PhoneVerificationRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PhoneVerificationSendRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PhoneVerificationVerifyRequest;
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PhoneVerificationProcessRequest;
...
class PhoneVerificationController extends AbstractController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PhoneVerificationRequest $request
     *
     ...
     * Show the phone verification form.
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PhoneVerificationVerifyRequest $request
     *
     * @return \Illuminate\View\View
     */
