...
use Cortex\Auth\B2B2C2\Http\Requests\Frontarea\AccountAttributesRequest;
...
class AccountAttributesController extends AuthenticatedController
{
     ...
     *
     * @param \Cortex\Auth\B2B2C2\Http\Requests\Frontarea\AccountAttributesRequest $request
     *
