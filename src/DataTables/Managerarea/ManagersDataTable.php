...
class ManagersDataTable extends AbstractDataTable
{
    ...
    protected function getColumns(): array
    {
        $link = config('cortex.foundation.route.locale_prefix')
            ? '"<a href=\""+routes.route(\'managerarea.managers.edit\', {manager: full.username, locale: \''.$this->request->segment(1).'\'})+"\">"+data+"</a>"'
            : '"<a href=\""+routes.route(\'managerarea.managers.edit\', {manager: full.username})+"\">"+data+"</a>"';
        ...
        return [
            ...
            'full_name' => ['title' => trans('cortex/auth::common.full_name')],
