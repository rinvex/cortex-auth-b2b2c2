...
{{-- Scripts --}}
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\PhoneVerificationProcessRequest::class)->selector('#tenantarea-verification-phone-token-form')->ignore('.skip-validation') !!}
@endpush
