...
{{-- Page Title --}}
@section('title')
    {{ $currentTenant->title }} » {{ trans('cortex/auth::common.login') }}
@endsection

{{-- Scripts --}}
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AuthenticationRequest::class)->selector('#tenantarea-login-form') !!}
@endpush
