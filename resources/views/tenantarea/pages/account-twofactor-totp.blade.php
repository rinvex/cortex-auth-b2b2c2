...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\B2B2C2\Http\Requests\Tenantarea\AccountTwoFactorTotpProcessRequest::class)->selector('#tenantarea-twofactor-totp-form')->ignore('.skip-validation') !!}
@endpush
