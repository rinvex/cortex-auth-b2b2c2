                    ...
                    <div class="profile-content">
                                            ...
                                            <div class="panel-heading" role="tab" id="heading-{{ $session->getKey() }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                                        <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-confirmation" data-modal-action="{{ route('managerarea.account.sessions.destroy', ['id' => $session->getKey()]) }}" data-modal-title="{!! trans('cortex/foundation::messages.delete_confirmation_title') !!}" data-modal-body="{!! trans('cortex/foundation::messages.delete_confirmation_body', ['resource' => trans('cortex/auth::common.session'), 'identifier' => $session->id]) !!}" title="{{ trans('cortex/foundation::common.delete') }}"><i class="fa fa-remove"></i></a>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center profile-buttons">
                                <a class="btn btn-danger" href="#" data-toggle="modal" data-target="#delete-confirmation" data-modal-action="{{ route('managerarea.account.sessions.flush') }}" data-modal-title="{!! trans('cortex/foundation::messages.delete_confirmation_title') !!}" data-modal-body="{!! trans('cortex/foundation::messages.delete_confirmation_body', ['resource' => trans('cortex/auth::common.sessions'), 'identifier' => 'all']) !!}" title="{{ trans('cortex/foundation::common.delete') }}"><i class="fa fa-remove"></i> {{ trans('cortex/auth::messages.sessions.flush_all_heading') }}</a>
                            </div>
                        </div>
