...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\B2B2C2\Http\Requests\Frontarea\AccountAttributesRequest::class)->selector('#frontarea-account-attributes-form')->ignore('.skip-validation') !!}
@endpush
