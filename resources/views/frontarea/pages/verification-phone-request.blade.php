...
{{-- Scripts --}}
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\B2B2C2\Http\Requests\Frontarea\PhoneVerificationSendRequest::class)->selector('#frontarea-verification-phone-request-form')->ignore('.skip-validation') !!}
@endpush
